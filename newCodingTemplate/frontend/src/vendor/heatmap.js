        ...
        function WebGLHeatmap(_arg) {
            ...
            if (gradientTexture) {
                ...
                getColorFun = 'vec3 getColor(float intensity){\n' +
                    'vec3 blue = vec3(0.99,0.98,0.99);\n    ' +
                    'vec3 cyan = vec3(0.94,0.93,0.96);\n    ' +
                    'vec3 green = vec3(0.85,0.85,0.92);\n    ' +
                    'vec3 yellow = vec3(0.74,0.74,0.86);\n    ' +
                    'vec3 red = vec3(0.62,0.60,0.78);\n\n    ' +
                    'vec3 color = (\n            ' +
                ...
                //purple background
                // 'vec3 blue = vec3(0.94,0.93,0.96);\n    ' +
                // 'vec3 cyan = vec3(0.85,0.85,0.92);\n    ' +
                // 'vec3 green = vec3(0.74,0.74,0.86);\n    ' +
                // 'vec3 yellow = vec3(0.62,0.60,0.78);\n    ' +
                // 'vec3 red = vec3(0.50,0.49,0.73);\n\n    ' +
                //orange background
                // 'vec3 blue = vec3(0.98,0.93,0.88);\n    ' +
                // 'vec3 cyan = vec3(0.97,0.88,0.79);\n    ' +
                // 'vec3 green = vec3(0.96,0.83,0.71);\n    ' +
                // 'vec3 yellow = vec3(0.95,0.78,0.62);\n    ' +
                // 'vec3 red = vec3(0.92,0.67,0.44);\n\n    ' +
